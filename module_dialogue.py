# -*- coding: utf-8 -*-
from ernie.fast_ernie import FastErnie
...
class DialogueSpeechReceiverModule(naoqi.ALModule):
    ...
    def encode(self, s):
        ...
        return codecs.decode(s, 'utf-8', 'ignore')

    # def encode_utf8(self, s):
    #     # encoded_string = s.encode(encoding='utf-8')
    #     encoded_string = codecs.encode(s, encoding='utf-8')
    #     return encoded_string

    def processRemote(self, signalName, message):
        message = message.decode('utf-8')
        fast_ernie = FastErnie("0DE910E4BCE75DD89C33619A399DCA1B:FG=1",
                               "GFuLW9jajZLVkk1cWptSUhaVHBXNlEtY2pkYm9MMXlPcmFBdlR6ZzNRMWxYeXBsRVFBQUFBJCQAAAAAAQAAAAEAAACVTS98eXlkZHNzaGVhcnQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGXSAmVl0gJlM")
        ...
        if message == 'error':
            ...
            answer = fast_ernie.ask(message)['answer']
